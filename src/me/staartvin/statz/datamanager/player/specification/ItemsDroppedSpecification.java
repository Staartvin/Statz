...
public class ItemsDroppedSpecification extends PlayerStatSpecification {

    public ItemsDroppedSpecification(UUID uuid, int value, String worldName, Material material) {
        super();
    ...
    public static Material getItemDropped(Query query) {
