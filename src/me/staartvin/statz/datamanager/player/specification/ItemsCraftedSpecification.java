...
public class ItemsCraftedSpecification extends PlayerStatSpecification {

    public ItemsCraftedSpecification(UUID uuid, int value, String worldName, Material material) {
        super();
    ...
    public static Material getItemCrafted(Query query) {
